                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="table-container">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                                <form action="{{asset('admin/dia-diem/tim-kiem')}}" method="POST" accept-charset="utf-8">
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                 ...
                                                 <div class="actions"><a href="{{asset('admin/dia-diem/them-moi')}}" class="btn btn-info btn-sm"><i class="fa fa-plus"></i>&nbsp;Thêm mới</a>&nbsp;
                                                </div>
                                            </div>
