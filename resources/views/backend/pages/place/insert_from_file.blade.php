        ...
        <div id="page-wrapper"><!--BEGIN TITLE & BREADCRUMB PAGE-->
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                <div class="page-header pull-left">
                    <div class="page-title">Thêm mới địa điểm từ file</div>
                </div>
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-lg-12">
                        <form id="fileupload" action="{{asset('admin/dia-diem/them-moi-tu-file')}}" method="POST" enctype="multipart/form-data">
