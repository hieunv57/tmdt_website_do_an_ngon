        ...
        <div id="page-wrapper"><!--BEGIN TITLE & BREADCRUMB PAGE-->
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                <div class="page-header pull-left">
                    <div class="page-title">Thêm mới địa điểm</div>
                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="panel panel-blue">
                                            ...
                                            <div class="panel-body pan">
                                                <form method="POST" action="{{asset('admin/dia-diem/them-moi')}}"  class="form-horizontal form-bordered" enctype="multipart/form-data">
                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                    <div class="form-body">
                                                        <div class="form-group"><label  class="col-md-3 control-label">Tên địa điểm<span class='require'>*</span></label>
                                                        ...
                                                        <div class="form-group"><label  class="col-md-3 control-label">Địa chỉ<span class='require'>*</span></label>

                                                            <div class="col-md-9">
                                                                <div class="input-icon"></i><input name="address"  type="text" class="form-control"/></div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group"><label class="col-md-3 control-label">Số điện thoại</label>

                                                            <div class="col-md-9">
                                                                <div class="input-icon right"><input  name="phone" type="number" placeholder="" class="form-control"/></div>
                                                            </div>
                                                        </div>
                                                         <div class="form-group"><label class="col-md-3 control-label">Giá thành</label>

                                                            <div class="col-md-9">
                                                                <div class="input-icon right"><input  name="price" type="text" placeholder="Giá từ ... đến ..." class="form-control"/></div>
                                                            </div>
                                                        </div>
                                                         <div class="form-group"><label class="col-md-3 control-label">Thời gian mở cửa</label>

                                                            <div class="col-md-9">
                                                                <div class="input-icon right"><input  name="timeopen" type="text" placeholder="Từ ... đến ..." class="form-control"/></div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group"><label class="col-md-3 control-label">Ảnh chính<span class='require'>*</span></label>

                                                            <div class="col-md-9">
                                                                <div class="input-icon right"><input  required name="fImages" type="file"  class="form-control"/></div>
                                                            </div>
                                                        </div>
                                                         <div class="form-group"><label class="col-md-3 control-label">Video giới thiệu</label>

                                                            <div class="col-md-9">
                                                                <div class="input-icon right"><input  name="video" type="text" placeholder="http://youtube.com/..." class="form-control"/></div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group"><label for="inputAddress1" class="col-md-3 control-label">Giới thiệu địa điểm<span class='require'>*</span></label>
