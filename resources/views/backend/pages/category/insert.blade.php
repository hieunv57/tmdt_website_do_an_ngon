        ...
        <div id="page-wrapper"><!--BEGIN TITLE & BREADCRUMB PAGE-->
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                <div class="page-header pull-left">
                    <div class="page-title">Thêm mới danh mục</div>
                </div>
                                    ...
                                    @endif
                                        <div class="panel panel-blue">
                                            ...
                                            <div class="panel-body pan">
                                                <form action="{{asset('admin/danh-muc/them-moi')}}" method="POST" class="form-horizontal form-bordered">
                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                    <div class="form-body">
                                                        <div class="form-group"><label class="col-md-3 control-label">Tên<span class='require'>*</span></label>
                                                        ...
                                                        <div class="form-group"><label class="col-md-3 control-label">Mô tả</label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="input-icon right"><input  name="description" type="text" placeholder="" class="form-control"/></div>
                                                            </div>
                                                        </div>
                                                    </div>
