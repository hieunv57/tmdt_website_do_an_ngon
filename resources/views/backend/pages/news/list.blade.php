                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="table-container">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                                <form action="{{asset('admin/tin-tuc/tim-kiem')}}" method="POST" accept-charset="utf-8">
                                            ...
                                            <table class="table table-hover table-striped table-bordered table-advanced tablesorter">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="{{url('admin/tin-tuc/xem/'.$item->id)}}">
                                                        <button type="button" class="btn btn-default btn-xs"><i class="fa fa-edit"></i>&nbsp;
                                                            Xem
                                                        </button>
                                                    </a>
                                                    <a href="{{url('admin/tin-tuc/xoa/'.$item->id)}}" onclick="return confirm('Bạn có chắc chắn xóa người dùng này ?')">
