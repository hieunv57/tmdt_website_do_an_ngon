        ...
        <div id="page-wrapper"><!--BEGIN TITLE & BREADCRUMB PAGE-->
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                <div class="page-header pull-left">
                    <div class="page-title">Thêm mới món ăn</div>
                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="panel panel-blue">
                                            ...
                                            <div class="panel-body pan">
                                                <form method="POST" action="{{asset('admin/mon-an/them-moi')}}"  class="form-horizontal form-bordered" enctype="multipart/form-data">
                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                    <div class="form-body">
                                                        <div class="form-group"><label  class="col-md-3 control-label">Tên món<span class='require'>*</span></label>
                                                        ...
                                                        <div class="form-group"><label for="inputAddress1" class="col-md-3 control-label">Giới thiệu món<span class='require'>*</span></label>
