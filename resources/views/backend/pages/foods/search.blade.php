        ...
        <div id="page-wrapper"><!--BEGIN TITLE & BREADCRUMB PAGE-->
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                <div class="page-header pull-left">
                    <div class="page-title">Kết quả tìm kiếm món ăn</div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="table-container">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                                <form action="{{asset('admin/mon-an/tim-kiem')}}" method="POST" accept-charset="utf-8">
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                 ...
                                                 <div class="actions"><a href="{{asset('admin/mon-an/them-moi')}}" class="btn btn-info btn-sm"><i class="fa fa-plus"></i>&nbsp;Thêm mới</a>&nbsp;
                                                </div>
                                            </div>
                                            <table class="table table-hover table-striped table-bordered table-advanced tablesorter">
                                                ...
                                                <tr>
                                                    <td>{{$item->id}}</td>
                                                    <td><img src="{{asset('public/backend/images/foods/'. $item->image)}}" style="height:90px; width:100px" alt=""></td>
                                                    ...
                                                    <td>
                                                    <a href="{{url('admin/dia-diem/xem/'.$item->id)}}">
                                                        <button type="button" class="btn btn-default btn-xs"><i class="fa fa-edit"></i>&nbsp;
                                                            Xem
                                                        </button>
                                                    </a>
                                                    <a href="{{url('admin/dia-diem/xoa/'.$item->id)}}" onclick="return confirm('Bạn có chắc chắn xóa người dùng này ?')">
