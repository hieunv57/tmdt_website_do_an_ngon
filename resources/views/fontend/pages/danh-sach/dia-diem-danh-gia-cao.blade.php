        ...
        <div class="b-breadcrumbs f-breadcrumbs">
            <div class="container">
                <ul>
                    ...
                    <li><i class="fa fa-angle-right"></i><a href="#">Danh sách địa điểm được đánh giá cao</a></li>
                </ul>
            </div>
        </div>
                                    ...
                                    <div class="b-product-preview">
                                        ...
                                        <div class="b-product-preview__content">
                                            <div class="b-product-preview__content_col">
                                                <span class="b-product-preview__content_price f-product-preview__content_price f-primary-b">{{$item->avg_point}}/10</span>
                                            </div>
                                            <div class="b-product-preview__content_col">
