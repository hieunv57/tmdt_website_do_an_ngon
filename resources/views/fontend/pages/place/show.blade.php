                            ...
                            <div class="b-product-card b-default-top-indent">
                                ...
                                <div class="b-product-card__info">
                                    ...
                                    <div class="b-product-card__info_row">
                                        ...
                                        <span class="f-primary-b c-tertiary f-title-smallest">{{$place_detail->view}} lượt xem</span>
                                    </div>
                                    <div class="b-product-card__info_row">
                                    ...
                                    <div class="b-product-card__info_row">
                                        ...
                                        <a class="f-more f-title-smallest" href="">Danh mục</a>, <a class="f-more f-title-smallest" href="">{{$place_detail->category_name}}</a>
                                    </div>
                                    <div class="b-product-card__info_row">
                                        <div class="b-btn-group-hor f-btn-group-hor">
                                            <div class="fb-like" data-href="{{url('dia-diem/'.$place_detail->link)}}"  data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>
                            ...
                            <div class="b-tabs f-tabs j-tabs b-tabs-reset">
                                ...
                                <div class="b-tabs__content">
                                    <div id="tabs-21">
                                        ...
                                        <p><?php echo $place_detail->description ?></p>
                                        
                                    </div>
                                    <div id="tabs-22">
                                        <h4 class="f-tabs-vertical__title f-primary-b">Video giới thiệu</h4>
                                        <p><iframe src="{{$place_detail->video}}"></iframe></p>
