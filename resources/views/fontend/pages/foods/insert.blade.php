...
<div class="b-breadcrumbs f-breadcrumbs">
    <div class="container">
        <ul>
            ...
            <li><i class="fa fa-angle-right"></i><a href="#">Chia sẻ món ngon</a></li>
    ...
    <div class="col-md-8">
        <div class="b-contact-form-box--bord">
            ...
            @if(Session::has('flash_message'))
             ...
             @endif
                <form action="{{asset('dang-mon-ngon')}}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="col-md-6">
                        <div class="b-form-row">
                            <label class="b-form-vertical__label" for="name">Tên món</label>
                        ...
                        <div class="b-form-row">
                            <label class="b-form-vertical__label" for="email">Giá thành</label>
                            <div class="b-form-vertical__input">
...
<section>
    <div class="b-carousel-secondary f-carousel-secondary b-some-examples-tertiary f-some-examples-tertiary b-carousel-reset">
        <div class="b-carousel-title f-carousel-title f-primary-b">Món ngon mới</div>
